    ...
    <div class="sicontainer">
        ...
        <div class="siprofile">
            <div class="simid">
                ...
                <?php else : ?>
                    <img class="rounded-circle shadow-lg border float-start me-3" src="img/<?= $mahasiswa['foto']; ?>" alt="">
                <?php endif; ?>
            </div>
        </div>
        <div class="siinfo">
            <div class="siinfotext">
                ...
                <a href="data_mahasiswa.php" class="float-end btn btn-primary">Kembali</a>
            </div>
